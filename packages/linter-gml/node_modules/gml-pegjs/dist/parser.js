module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c38 = "_",
        peg$c39 = { type: "literal", value: "_", description: "\"_\"" },
        peg$c40 = "\u200C",
        peg$c41 = { type: "literal", value: "\u200C", description: "\"\\u200C\"" },
        peg$c42 = "\u200D",
        peg$c43 = { type: "literal", value: "\u200D", description: "\"\\u200D\"" },
        peg$c44 = function() { return { type: "Literal", value: true  }; },
        peg$c45 = function() { return { type: "Literal", value: false }; },
        ...
        peg$c173 = function(callee, args) {
                return { type: "CallExpression", callee: callee, arguments: args };
              },
        peg$c174 = function(head, args) {
                  return { type: "CallExpression", arguments: args };
                },
        peg$c175 = function(head, accessor) {
                  return {
                    type:         "MemberExpression",
        ...
        peg$c176 = function(head, property) {
                  return {
                    type:     "MemberExpression",
                    property: property,
                    computed: false
        ...
        peg$c178 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c179 = function(head, tail) {
              return buildList(head, tail, 3);
            },
        peg$c180 = function(argument, operator) {
              return {
        ...
        peg$c185 = function(operator, argument) {
        ...
        peg$c203 = "mod",
        peg$c204 = { type: "literal", value: "mod", description: "\"mod\"" },
        peg$c205 = "div",
        peg$c206 = { type: "literal", value: "div", description: "\"div\"" },
        peg$c207 = /^[+=]/,
        ...
        peg$c244 = function(left, operator, right) {
              return {
                type:     "AssignmentExpression",
                operator: operator,
                left:     left,
        ...
        peg$c267 = function(head, tail) { return buildList(head, tail, 1); },
        peg$c268 = function(declarations) {
              return {
                type:         "VariableDeclaration",
                declarations: declarations
              };
            },
        peg$c269 = function(id, init) {
              return {
        ...
        peg$c270 = function() { return { type: "EmptyStatement" }; },
        ...
        peg$c272 = function(test, consequent, alternate) {
              return {
                type:       "IfStatement",
                test:       test,
        ...
        peg$c273 = function(test, consequent) {
              return {
                type:       "IfStatement",
                test:       test,
                consequent: consequent,
        ...
        peg$c274 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test }; },
        peg$c275 = function(test, body) { return { type: "WhileStatement", test: test, body: body }; },
        peg$c276 = function(init, test, update, body) {
              return {
                type:   "ForStatement",
        ...
        peg$c277 = function(declarations, test, update, body) {
              return {
                type:   "ForStatement",
                init:   {
                  type:         "VariableDeclaration",
        ...
        peg$c279 = function(label) {
              return { type: "ContinueStatement", label: label };
            },
        peg$c280 = function() {
              return { type: "BreakStatement", label: null };
            },
        peg$c281 = function(label) {
        ...
        peg$c284 = function(object, body) { return { type: "WithStatement", object: object, body: body }; },
        peg$c285 = function(discriminant, cases) {
              return {
        ...
        peg$c286 = function(clauses) {
              return optionalList(extractOptional(clauses, 0));
            },
        peg$c287 = function(before, default_, after) {
        ...
        peg$c290 = function(test, consequent) {
              return {
                type:       "SwitchCase",
                test:       test,
        ...
        peg$c292 = function(label, body) {
              return { type: "LabeledStatement", label: label, body: body };
            },
        peg$c293 = function() { return { type: "ExitStatement" } },
        peg$c294 = function(declarations) {
              return {
                type:         "GlobalVarDeclaration",
                declarations: declarations
              };
            },
        peg$c295 = function(times, body) { return { type: "RepeatStatement", times: times, body: body }; },
        peg$c296 = "#define ",
        peg$c297 = { type: "literal", value: "#define ", description: "\"#define \"" },
        peg$c298 = function(script) {
    ...
    function peg$parseGlobalVarToken() {
      var s0, s1, s2, s3;
    ...
    function peg$parseTupleArgumentList() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseDataStructureAccessor() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseMemberExpression() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parseDataStructureAccessor();
        if (s4 !== peg$FAILED) {
          peg$savedPos = s3;
          s4 = peg$c170(s1, s4);
        }
                          ...
                          if (s0 === peg$FAILED) {
                            ...
                            if (s0 === peg$FAILED) {
                              ...
                              if (s0 === peg$FAILED) {
                                ...
                                if (s0 === peg$FAILED) {
                                  s0 = peg$parseGlobalVarStatement();
                                  if (s0 === peg$FAILED) {
    ...
    function peg$parseGlobalVarStatement() {
      var s0, s1, s2, s3, s4;

      s0 = peg$currPos;
      s1 = peg$parseGlobalVarToken();
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseVariableDeclarationList();
